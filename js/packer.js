            ...
            while (groupItems.length > 0) {
                ...
                for (let i = groupItems.length - 1; i >= 0; i--) {
                    ...
                    if (currentX + neededWidth <= this.width) {
                        ...
                        if (x > 0) this.cutLinesX.add(x);
                        if (x + item.width < this.width) this.cutLinesX.add(x + item.width);
                ...
                if (stripY > 0) this.cutLinesY.add(stripY);
                if (this.currentY < this.height) this.cutLinesY.add(this.currentY);
    ...
    packWithStrips(items) {
        ...
        for (const stripHeight of sortedHeights) {
            ...
            while (groupItems.length > 0) {
                ...
                if (stripY > 0) this.cutLinesY.add(stripY);
                if (currentY < this.height) this.cutLinesY.add(currentY);
